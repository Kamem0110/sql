-- SEMANA 2 // MATERIALIZAR MODELO FÍSICO
CREATE TABLE TB_BRH
(
...
UPDATE BRH.PAPEL SET NOME = 'Especialista de Negócios' WHERE ID = 8;

-- DEPARTAMENTO OK
INSERT INTO brh.departamento
(sigla, nome, chefe, departamento_superior)
VALUES
('BI', 'Especialista de Negócios', 'A121', 'DEREH');
...
(cpf, colaborador, nome, parentesco, data_nascimento)
VALUES
('073.340.136-38', 'A121', 'Cicrana de Tal', 'CÃ´njuge', to_date('02/06/1968', 'DD/MM/YYYY'));

--SEMANA 2 // RELATÓRIO DE DEPARTAMENTO
SELECT SIGLA, NOME FROM BRH.DEPARTAMENTO ORDER BY NOME;

-- SEMANA 2 // RELATÓRIO DE CONTATOS
